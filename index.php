...
<head>
    ...
    <link rel="stylesheet" href="../src/css/übung.css">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Julius+Sans+One&family=Libre+Baskerville:ital@0;1&display=swap" rel="stylesheet"><script src="https://kit.fontawesome.com/c123f3311d.js" crossorigin="anonymous"></script>
    <title>Ali's coole Webseite</title>
</head>
<body>
        ...
        <div class="main-content">
            ...
            <article class="intro">
                ...
                <div class="designer">
                    ...
                    <ul>
                        <li><h2><a href="#">mid century modern</a></h2></li>
                        <li><span>by</span><a href="#"> Andrew Lohman</a></li>
                        <li><h2><a href="#">garments</a></h2></li>
                        <li><span>by</span><a href="#"> Dan Mall</a></li>
                        <li><h2><a href="#">steel</a></h2></li>
                        <li><span>by</span><a href="#"> Steffen Knoedller</a></li>
                        <li><h2><a href="#">apothecary</a></h2></li>
                        <li><span>by</span><a href="#"> Trent Walton</a></li>
                        <li><h2><a href="#">screen filler</a></h2></li>
                        <li><span>by</span><a href="#"> Elliot Jay Stocks</a></li>
                        <li><h2><a href="#">fountain kiss</a></h2></li>
                        <li><span>by</span><a href="#"> Jeremy Carlson</a></li>
                        <li><h2><a href="#">a robot named jimmy</a></h2></li>
                        <li><span>by</span><a href="#"> meltmedia</a></li>
                        <li><h2><a href="#">verde moderna</a></h2></li>
                        <li><span>by</span><a href="#"> Dave Shea</a></li>
                    </ul>
            ...
            <div class="background">
                ...
                <article class="participation">
                    ...
                    <div class="info">
                        <ul>
                            <li><a href="#">view this design's <span>css</span></a></li>
                            <li><a href="#"><span>css</span> resources</a></li>
